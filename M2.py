...
path=r"C:\Users\mites\OneDrive\Desktop\Placement\Resume\Specs.pdf"
PVCurrent=DoubleVar()
...
Label6=Label(root1,text="Enter Temprature in Celsius :",font=('Arial',12),fg='gainsboro',bg='black').place(x=60,y=210)
